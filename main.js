...
var leafshadowone = new Image();
var leafone = new Image();
var leafshadowtwo = new Image();
var leaftwo = new Image();
var leafshadowthree = new Image();
var leafthree = new Image();
var leafshadowfour = new Image();
var leaffour = new Image();
var leafshadowfive = new Image();
var leaffive = new Image();
var leafshadowsix = new Image();
var leafsix = new Image();
var leafshadowseven = new Image();
var leafseven = new Image();
var personshadowone = new Image();
var mask = new Image();
var personshadowtwo = new Image();
...
var layer_list = [
	{
        ...
        {
		'image': leafshadowfive,
		'src': './images/layer_10.png',
		'z_index': -1.35,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1 
        ...
        {
		'image': leafshadowseven,
		'src': './images/layer_14.png',
		'z_index': -0.95,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1 
...
//Initialize variables or motion-based parallax
var motion_initial = {
	x: null,
	y: null
};
...
window.addEventListener('deviceorientation', function(event) {
	...
	if (window.orientation === 0) {
		...
		motion.x = -event.beta + motion_initial.x;
		motion.y = event.gamma - motion_intial.y;
	} else {
		// The device is upside down
		motion.x = -event.gamma + motion_intial.y;
		motion.y = -event.beta + motion_initial.x;
	}
